...
def test_secteur_ouestfrance_vient_du_cp_de_l_url():
    ...
    assert scrap.url_of_vers_secteur(href) == "Vannes"
    assert scrap.url_of_vers_secteur("/immobilier/location/maison/saint-ave-56-56890/t3-2.htm") == "Saint Ave"
    # Meme URL dans une ville a arrondissements -> le CP prend le dessus.
    assert scrap.url_of_vers_secteur("/immobilier/location/appartement/paris-75-75011/x.htm") == "Paris 11e"
    assert scrap.url_of_vers_secteur("url/sans/commune") is None
